...
import {
    AppRegistry,Platform,ListView,StyleSheet,StatusBar,Text,TouchableHighlight,View
} from 'react-native';
...
export default class StopWatchDemo extends Component {
  constructor(props){
    super(props) ;
    this.state = {
        stopWatch: false,
...
AppRegistry.registerComponent('StopWatchDemo', () => StopWatchDemo);
